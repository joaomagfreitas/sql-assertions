...
func IsConstraintCheck(err error) bool {
	return validate(err, sqlite3.ErrConstraint, sqlite3.ErrConstraintCheck)
}
...
func IsConstraintPrimaryKey(err error) bool {
	return validate(err, sqlite3.ErrConstraint, sqlite3.ErrConstraintPrimaryKey)
}
...
func IsConstraintForeignKey(err error) bool {
	return validate(err, sqlite3.ErrConstraint, sqlite3.ErrConstraintForeignKey)
}
...
func IsConstraintUnique(err error) bool {
	return validate(err, sqlite3.ErrConstraint, sqlite3.ErrConstraintUnique)
}
...
func IsConstraintRowId(err error) bool {
	return validate(err, sqlite3.ErrConstraint, sqlite3.ErrConstraintRowID)
}
...
func IsConstraintNotNull(err error) bool {
	return validate(err, sqlite3.ErrConstraint, sqlite3.ErrConstraintNotNull)
}
...
func IsConstraintDataType(err error) bool {
	return validate(err, sqlite3.ErrConstraint, sqlite3.ErrConstraint.Extend(12))
}
