package sqlite3_assertions_test

import (
	"database/sql"
	"testing"

	sqlite3_assertions "github.com/joaomagfreitas/sql-assertions/sqlite3"
...
func TestConstraints(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			asserter: sqlite3_assertions.IsConstraintPrimaryKey,
		},
		{
			desc: "foreign key",
			dml: func() error {
		...
		`)
			...
			asserter: sqlite3_assertions.IsConstraintForeignKey,
		},
		{
			desc: "unique",
			dml: func() error {
		...
		`)
			...
			asserter: sqlite3_assertions.IsConstraintUnique,
		},
		{
			desc: "rowid",
			dml: func() error {
		...
		`)
			...
			asserter: sqlite3_assertions.IsConstraintRowId,
		},
		{
			desc: "not null",
			dml: func() error {
		...
		`)
			...
			asserter: sqlite3_assertions.IsConstraintNotNull,
		},
		{
			desc: "datatype",
			dml: func() error {
		...
		`)
			...
			asserter: sqlite3_assertions.IsConstraintDataType,
		},
	}
